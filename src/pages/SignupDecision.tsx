    ...
    <main className="w-full sm:w-[24rem] mx-auto">
      <div className=" pt-4 text-center">
        ...
        <section className="text-black px-3">
          <p className="text-[1.5rem]  sm:text-2xl leading-8 text-black font-bold  mt-8 text-left">
          ...
          <ul className="space-y-4 text-left text-black dark:text-gray-400">
            <li className="flex items-start justify-start space-x-2 sm:space-x-3 mt-4">
              <input
                type="checkbox"
                className="w-5 h-5 sm:w-7 sm:h-7 form-checkbox rounded-full focus:ring-0"
              />
              <p className="text-xs font-medium flex-1">
                I consent to be contacted by, or on behalf of, Tandym via
                automated means for my account.
              </p>
            </li>
            ...
            <li className="flex items-start  justify-start space-x-2 sm:space-x-3 mt-4">
              ...
              <p className="text-xs font-medium flex-1">
                ...
                <span className="text-blue-600">
                  Electronic Communications Disclosure, Terms & Conditions and
                  Privacy Notice.
                </span>
              </p>
            </li>
          ...
          {showButton ? (
            <button className="bg-black  cursor-pointer border-none  mx-auto text-base font-semibold mt-8 w-full text-white rounded-3xl py-2  mb-8"  onClick={()=>navigate('/confirm-page')}>
              Get a Decision Now
            </button>
          ) : (
